...
def generate_PEMS_dataset_adj(dataset_name,device, data_used_subset= False, subset_percent = 0.2):
    file_path = "/home/traffic/deep_learning_implementation/flow_data/data/"+ dataset_name +"/" + dataset_name
    if dataset_name == "PEMS04_speed":
        file_path = "/home/traffic/deep_learning_implementation/flow_data/data/" + 'PEMS04' + "/" + 'PEMS04'
    if dataset_name == "PEMS08_speed":
        file_path = "/home/traffic/deep_learning_implementation/flow_data/data/" + 'PEMS08' + "/" + 'PEMS08'
