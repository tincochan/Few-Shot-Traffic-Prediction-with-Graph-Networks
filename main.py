...
pre_used_timestamps = []
#### Pre_Training
if os.path.exists('/home/traffic/GitHub/GN_pytorch/experiment/transfer_without_finetune/'+ trained_model_path +'.pt') == False:
    file_exsits = os.path.exists('/home/traffic/GitHub/GN_pytorch/experiment/transfer_without_finetune/'+ trained_model_path +'.pt')
    print(os.path.exists('/home/traffic/GitHub/GN_pytorch/experiment/transfer_without_finetune/'+ trained_model_path +'.pt'))
